...
//        assertEquals("com.kabouzeid.gramophone", appContext.getPackageName());
//    }
...
//     */
//    @Test
//    public void clickPlayStopMusic() {
//        Matcher<View> miniPlayerPlayPause = withId(R.id.mini_player_play_pause_button);
...
//     */
//    @Test
//    public void buttonPlayerNextPerv() {
...
//                .perform(RecyclerViewActions.actionOnItemAtPosition(1, clickChildViewWithId(R.id.menu)));
//        onView(allOf(withId(R.id.title), withText("Добавить в плейлист...")))
//                .perform(click())
//                .check(matches(isDisplayed()));
        onView(withId(R.id.mini_player_image))
                .perform(click());
